...
#line 249
char (*main_token_kind_name(main_TokenKind kind));
...
#line 192
extern char (*(main_token_kind_names[54]));
...
TypeInfo *typeinfo_table[264] = {
    ...
    [32] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(TypeInfo), .align = alignof(TypeInfo), .name = "TypeInfo", .num_fields = 10, .fields = (TypeFieldInfo[]) {
        ...
        {"enum_items", .type = TYPEID(42, TYPE_PTR, TypeEnumItemInfo *), .offset = offsetof(TypeInfo, enum_items)},
    ...
    [40] = NULL, // Func
    [41] = NULL, // Func
    [42] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(31, TYPE_STRUCT, TypeEnumItemInfo)},
    [43] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [147]), .align = alignof(char [147]), .base = TYPEID(3, TYPE_CHAR, char), .count = 147},
    [44] = NULL, // Func
    [45] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [9]), .align = alignof(char [9]), .base = TYPEID(3, TYPE_CHAR, char), .count = 9},
    [46] = NULL, // Func
    [47] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [2]), .align = alignof(char [2]), .base = TYPEID(3, TYPE_CHAR, char), .count = 2},
    [48] = &(TypeInfo){TYPE_CONST, .size = sizeof(char const ), .align = alignof(char const ), .base = TYPEID(3, TYPE_CHAR, char)},
    [49] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(48, TYPE_CONST, char const )},
    [50] = NULL, // Func
    [51] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [8]), .align = alignof(char [8]), .base = TYPEID(3, TYPE_CHAR, char), .count = 8},
    [52] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [5]), .align = alignof(char [5]), .base = TYPEID(3, TYPE_CHAR, char), .count = 5},
    [53] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [7]), .align = alignof(char [7]), .base = TYPEID(3, TYPE_CHAR, char), .count = 7},
    [54] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(main_Token), .align = alignof(main_Token), .name = "main_Token", .num_fields = 10, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(55, TYPE_ENUM, main_TokenKind), .offset = offsetof(main_Token, kind)},
        {"mod", .type = TYPEID(56, TYPE_ENUM, main_TokenMod), .offset = offsetof(main_Token, mod)},
        {"suffix", .type = TYPEID(57, TYPE_ENUM, main_TokenSuffix), .offset = offsetof(main_Token, suffix)},
        {"pos", .type = TYPEID(58, TYPE_STRUCT, main_SrcPos), .offset = offsetof(main_Token, pos)},
    ...
    [59] = NULL, // No associated type
    [60] = NULL, // Func
    [61] = NULL, // Func
    [62] = NULL, // Func
    [63] = NULL, // Func
    [64] = NULL, // Func
    [65] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [29]), .align = alignof(char [29]), .base = TYPEID(3, TYPE_CHAR, char), .count = 29},
    [66] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char *[54]), .align = alignof(char *[54]), .base = TYPEID(16, TYPE_PTR, char *), .count = 54},
    [67] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [3]), .align = alignof(char [3]), .base = TYPEID(3, TYPE_CHAR, char), .count = 3},
    [68] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char *[54]), .align = alignof(char *[54]), .base = TYPEID(16, TYPE_PTR, char *), .count = 54},
    [69] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(16, TYPE_PTR, char *)},
    [70] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [10]), .align = alignof(char [10]), .base = TYPEID(3, TYPE_CHAR, char), .count = 10},
    [71] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [36]), .align = alignof(char [36]), .base = TYPEID(3, TYPE_CHAR, char), .count = 36},
    [72] = NULL, // Func
    [73] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [256]), .align = alignof(char [256]), .base = TYPEID(3, TYPE_CHAR, char), .count = 256},
    [74] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [34]), .align = alignof(char [34]), .base = TYPEID(3, TYPE_CHAR, char), .count = 34},
    [75] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [38]), .align = alignof(char [38]), .base = TYPEID(3, TYPE_CHAR, char), .count = 38},
    [76] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(17, TYPE_PTR, void *)},
    [77] = NULL, // Func
    [78] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [56]), .align = alignof(char [56]), .base = TYPEID(3, TYPE_CHAR, char), .count = 56},
    [79] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [45]), .align = alignof(char [45]), .base = TYPEID(3, TYPE_CHAR, char), .count = 45},
    [80] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(8, TYPE_INT, int)},
    [81] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [57]), .align = alignof(char [57]), .base = TYPEID(3, TYPE_CHAR, char), .count = 57},
    [82] = NULL, // Func
    [83] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [23]), .align = alignof(char [23]), .base = TYPEID(3, TYPE_CHAR, char), .count = 23},
    [84] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(uchar [256]), .align = alignof(uchar [256]), .base = TYPEID(4, TYPE_UCHAR, uchar), .count = 256},
    [85] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(4, TYPE_UCHAR, uchar)},
    [86] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [25]), .align = alignof(char [25]), .base = TYPEID(3, TYPE_CHAR, char), .count = 25},
    [87] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [33]), .align = alignof(char [33]), .base = TYPEID(3, TYPE_CHAR, char), .count = 33},
    [88] = NULL, // Func
    [89] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(main_Intern), .align = alignof(main_Intern), .name = "main_Intern", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"len", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(main_Intern, len)},
        {"next", .type = TYPEID(90, TYPE_PTR, main_Intern *), .offset = offsetof(main_Intern, next)},
        {"str", .type = TYPEID(95, TYPE_ARRAY, char [1]), .offset = offsetof(main_Intern, str)},
    }},
    [90] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(89, TYPE_STRUCT, main_Intern)},
    [91] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(main_Map), .align = alignof(main_Map), .name = "main_Map", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"keys", .type = TYPEID(94, TYPE_PTR, ullong *), .offset = offsetof(main_Map, keys)},
        {"vals", .type = TYPEID(94, TYPE_PTR, ullong *), .offset = offsetof(main_Map, vals)},
    ...
    [92] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(91, TYPE_STRUCT, main_Map)},
    [93] = NULL, // Func
    [94] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(13, TYPE_ULLONG, ullong)},
    [95] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [1]), .align = alignof(char [1]), .base = TYPEID(3, TYPE_CHAR, char), .count = 1},
    [96] = NULL, // Func
    [97] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(main_Arena), .align = alignof(main_Arena), .name = "main_Arena", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        ...
        {"blocks", .type = TYPEID(69, TYPE_PTR, char (**)), .offset = offsetof(main_Arena, blocks)},
    }},
    [98] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(97, TYPE_STRUCT, main_Arena)},
    [99] = NULL, // Func
    [100] = &(TypeInfo){TYPE_CONST, .size = 0, .align = 0, .base = TYPEID0(1, TYPE_VOID)},
    [101] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID0(100, TYPE_CONST)},
    [102] = NULL, // Func
    [103] = NULL, // Func
    [104] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(libc_VAList), .align = alignof(libc_VAList), .name = "libc_VAList", .num_fields = 1, .fields = (TypeFieldInfo[]) {
        {"bytes", .type = TYPEID(16, TYPE_PTR, char *), .offset = offsetof(libc_VAList, bytes)},
    }},
    [105] = NULL, // Func
    [106] = NULL, // Func
    [107] = NULL, // Func
    [108] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [30]), .align = alignof(char [30]), .base = TYPEID(3, TYPE_CHAR, char), .count = 30},
    [109] = NULL, // Func
    [110] = NULL, // Func
    [111] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(main_BufHdr), .align = alignof(main_BufHdr), .name = "main_BufHdr", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        ...
        {"buf", .type = TYPEID(95, TYPE_ARRAY, char [1]), .offset = offsetof(main_BufHdr, buf)},
    }},
    [112] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(111, TYPE_STRUCT, main_BufHdr)},
    [113] = NULL, // Func
    [114] = NULL, // Func
    [115] = NULL, // Func
    [116] = NULL, // Func
    ...
    [119] = NULL, // Func
    [120] = NULL, // Func
    [121] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(69, TYPE_PTR, char (**))},
    [122] = NULL, // Func
    [123] = NULL, // Func
    [124] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [13]), .align = alignof(char [13]), .base = TYPEID(3, TYPE_CHAR, char), .count = 13},
    [125] = NULL, // Func
    [126] = NULL, // Func
    [127] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [15]), .align = alignof(char [15]), .base = TYPEID(3, TYPE_CHAR, char), .count = 15},
    [128] = NULL, // Func
    [129] = NULL, // Func
    [130] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [16]), .align = alignof(char [16]), .base = TYPEID(3, TYPE_CHAR, char), .count = 16},
    [131] = NULL, // Func
    [132] = NULL, // Func
    [133] = NULL, // Func
    [134] = NULL, // Func
    ...
    [143] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char *[7]), .align = alignof(char *[7]), .base = TYPEID(16, TYPE_PTR, char *), .count = 7},
    [144] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char *[7]), .align = alignof(char *[7]), .base = TYPEID(16, TYPE_PTR, char *), .count = 7},
    [145] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(main_TokenKind [54]), .align = alignof(main_TokenKind [54]), .base = TYPEID(55, TYPE_ENUM, main_TokenKind), .count = 54},
    [146] = NULL, // Func
    [147] = NULL, // Func
    ...
    [163] = NULL, // Func
    [164] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(15, TYPE_DOUBLE, double)},
    [165] = NULL, // Func
    [166] = NULL, // Func
    [167] = NULL, // Func
    [168] = NULL, // Func
...
void test_lexer_test(void) {
    ...
    assert((main_token_info()) == ("<"));
    main_next_token();
    assert((strcmp(main_token_info(), "stdio")) == (0));
    main_next_token();
    assert((main_token_info()) == ("."));
    main_next_token();
    assert((strcmp(main_token_info(), "h")) == (0));
    main_next_token();
    assert((main_token_info()) == (">"));
    main_next_token();
    #line 30
    ...
    assert((strcmp(main_token_info(), "int")) == (0));
    main_next_token();
    assert((strcmp(main_token_info(), "argc")) == (0));
    main_next_token();
    assert((main_token_info()) == (","));
    main_next_token();
    assert((strcmp(main_token_info(), "char")) == (0));
    main_next_token();
    assert((main_token_info()) == ("*"));
    main_next_token();
    assert((main_token_info()) == ("*"));
    main_next_token();
    assert((strcmp(main_token_info(), "argv")) == (0));
    main_next_token();
    assert((main_token_info()) == (")"));
    main_next_token();
    assert((main_token_info()) == ("{"));
    ...
    assert((main_token_info()) == ("("));
    main_next_token();
    assert((strcmp(main_token_info(), "string")) == (0));
    main_next_token();
    assert((main_token_info()) == (")"));
    main_next_token();
    assert((main_token_info()) == (";"));
...
#line 331
char (*main_token_info(void)) {
    if (((main_token.kind) == (MAIN_TOKEN_NAME)) || ((main_token.kind) == (MAIN_TOKEN_KEYWORD))) {
        return main_token.name;
    } else {
        return main_token_kind_name(main_token.kind);
    }
}
...
#line 249
char (*main_token_kind_name(main_TokenKind kind)) {
    if ((kind) < ((sizeof(main_token_kind_names)) / (sizeof(*(main_token_kind_names))))) {
        return main_token_kind_names[kind];
    } else {
        return "<unknown>";
    }
}
...
char (*(main_token_kind_names[54])) = {[MAIN_TOKEN_EOF] = "EOF", [MAIN_TOKEN_COLON] = ":", [MAIN_TOKEN_LPAREN] = "(", [MAIN_TOKEN_RPAREN] = ")", [MAIN_TOKEN_LBRACE] = "{", [MAIN_TOKEN_RBRACE] = "}", [MAIN_TOKEN_LBRACKET] = "[", [MAIN_TOKEN_RBRACKET] = "]", [MAIN_TOKEN_COMMA] = ",", [MAIN_TOKEN_DOT] = ".", [MAIN_TOKEN_AT] = "@", [MAIN_TOKEN_POUND] = "#", [MAIN_TOKEN_ELLIPSIS] = "...", [MAIN_TOKEN_QUESTION] = "?", [MAIN_TOKEN_SEMICOLON] = ";", [MAIN_TOKEN_KEYWORD] = "keyword", [MAIN_TOKEN_INT] = "int", [MAIN_TOKEN_FLOAT] = "float", [MAIN_TOKEN_STR] = "string", [MAIN_TOKEN_NAME] = "name", [MAIN_TOKEN_NEG] = "~", [MAIN_TOKEN_NOT] = "!", [MAIN_TOKEN_MUL] = "*", [MAIN_TOKEN_DIV] = "/", [MAIN_TOKEN_MOD] = "%", [MAIN_TOKEN_AND] = "&", [MAIN_TOKEN_LSHIFT] = "<<", [MAIN_TOKEN_RSHIFT] = ">>", [MAIN_TOKEN_ADD] = "+", [MAIN_TOKEN_SUB] = "-", [MAIN_TOKEN_OR] = "|", [MAIN_TOKEN_XOR] = "^", [MAIN_TOKEN_EQ] = "==", [MAIN_TOKEN_NOTEQ] = "!=", [MAIN_TOKEN_LT] = "<", [MAIN_TOKEN_GT] = ">", [MAIN_TOKEN_LTEQ] = "<=", [MAIN_TOKEN_GTEQ] = ">=", [MAIN_TOKEN_AND_AND] = "&&", [MAIN_TOKEN_OR_OR] = "||", [MAIN_TOKEN_ASSIGN] = "=", [MAIN_TOKEN_ADD_ASSIGN] = "+=", [MAIN_TOKEN_SUB_ASSIGN] = "-=", [MAIN_TOKEN_OR_ASSIGN] = "|=", [MAIN_TOKEN_AND_ASSIGN] = "&=", [MAIN_TOKEN_XOR_ASSIGN] = "^=", [MAIN_TOKEN_MUL_ASSIGN] = "*=", [MAIN_TOKEN_DIV_ASSIGN] = "/=", [MAIN_TOKEN_MOD_ASSIGN] = "%=", [MAIN_TOKEN_LSHIFT_ASSIGN] = "<<=", [MAIN_TOKEN_RSHIFT_ASSIGN] = ">>=", [MAIN_TOKEN_INC] = "++", [MAIN_TOKEN_DEC] = "--", [MAIN_TOKEN_COLON_ASSIGN] = ":="};
#line 481
int main_scan_hex_escape(void) {
